#  AfyaLink - Digital E-Clinic & Triage System
...
AfyaLink is a modern web application that provides accessible healthcare services including online triage, appointment scheduling, real-time chat, and health education for underserved communities.

![AfyaLink Banner](https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1200&h=400&fit=crop)
...
**Doctor Account:**
- Email: `doctor@AfyaLink.com`
- Password: `doctor123`

**Patient Account:**
- Email: `patient@AfyaLink.com`
- Password: `patient123`
...
TEST_MONGODB_URI=mongodb://localhost:27017/AfyaLink-test
...
4. Set environment variables:
   - `VITE_API_URL=https://AfyaLink-hpf9.onrender.com`
5. Deploy: https://AfyaLink-client.onrender.com/
...
5. Deploy: https://AfyaLink-hpf9.onrender.com/
...
```bash
# Health check
curl https://AfyaLink-hpf9.onrender.com/api/health

# System status
curl https://AfyaLink-hpf9.onrender.com/api/status
```
...
- 💬 GitHub Issues: [Report a bug](https://github.com/yourusername/AfyaLink/issues)
- 📖 Documentation: [Wiki](https://github.com/yourusername/AfyaLink/wiki)

### System Status
- Backend: https://AfyaLink-hpf9.onrender.com/api/health
- Frontend: https://AfyaLink-client.onrender.com
...
### Quick Links
- [Live Demo](https://AfyaLink-client.onrender.com)
- [API Documentation](https://AfyaLink-hpf9.onrender.com)
- [Report Bug](https://github.com/yourusername/AfyaLink/issues)
- [Request Feature](https://github.com/yourusername/AfyaLink/issues)
